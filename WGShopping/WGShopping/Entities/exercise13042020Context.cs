...
{
    public partial class exercise13042020Context : DbContext
    {
        public exercise13042020Context()
        {
        }

        public exercise13042020Context(DbContextOptions<exercise13042020Context> options)
            : base(options)
        {
        }
